...
function Hero() {
  ...
  return (
    <div id="hero" className="relative flex flex-col items-center justify-center w-full min-h-screen px-4 py-12 ">
      ...
      {/* Content container with animation - full width */}
      <div className={`relative z-10 w-full max-w-full px-4 text-center transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
        ...
        <div className="mt-8">
          <button className="px-6 py-3 font-medium text-teal-900 transition-all bg-white rounded-lg shadow-lg hover:shadow-xl hover:bg-gray-100">
            Get Started
          </button>
        </div>
      </div>
